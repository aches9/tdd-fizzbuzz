...
public class FizzBuzzWhizzTest {
    ...
    @Test
    void should_Buzz_when_exactly_divisible_by_5_given_number() {
        FizzBuzzWhizz fizzBuzzWhizz = new FizzBuzzWhizz();
    ...
    @Test
    void should_Whizz_when_exactly_divisible_by_7_given_number() {
        FizzBuzzWhizz fizzBuzzWhizz = new FizzBuzzWhizz();
    ...
    @Test
    void should_FizzBuzz_when_exactly_divisible_by_3_and_5_given_number() {
        FizzBuzzWhizz fizzBuzzWhizz = new FizzBuzzWhizz();
    ...
    @Test
    void should_FizzWhizz_when_exactly_divisible_by_3_and_7_given_number() {
        FizzBuzzWhizz fizzBuzzWhizz = new FizzBuzzWhizz();
    ...
    @Test
    void should_BuzzWhizz_when_exactly_divisible_by_5_and_7_given_number() {
        FizzBuzzWhizz fizzBuzzWhizz = new FizzBuzzWhizz();
        String result = fizzBuzzWhizz.getFizzBuzzWhizz(35);
        Assertions.assertEquals("BuzzWhizz", result);
    }
    @Test
    void should_FizzBuzzWhizz_when_exactly_divisible_by_3_and_5_and_7_given_number() {
        FizzBuzzWhizz fizzBuzzWhizz = new FizzBuzzWhizz();
